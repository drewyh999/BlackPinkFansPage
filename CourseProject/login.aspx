...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <div  style="background-color: #ffd6a5; margin:auto; padding:50px;position:absolute; top:20%;left:20%;right:20%;width:500px;height:100px;">
            ...
            <div id="form" >
                ...
                &nbsp;&nbsp;&nbsp;
                <asp:TextBox runat="server" ID="phone0" CssClass="form1"></asp:TextBox>
                    <br />
                    </div>
                <br />
                <div style="display:block;text-align:center">
                <asp:Button runat="server" ID="loginbtn" CssClass =" form1" Text="登入" />
                    </div>
            </div>
        </div>
    </form>
