<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Roise.aspx.cs" Inherits="CourseProject.Roise" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
        body{
            background-image:url("img/roise_background.jpg")
        }
         .lgrgbtn {
    padding: 20px;
...
<body>
    <form id="form1" runat="server">
        <%--<div style="display:flex;align-items:center;justify-items:center;flex-direction:row">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/img/roise_self.jpg" Height="400px"  />
           <div >
               <asp:Image ID="Image2" runat="server" ImageUrl="~/img/roise_name.jpg" Width="400px" />
           ...
           <div >
            <table>
                <tr>
                    <td></td>
                    <td><asp:Image ID="Image2" runat="server" ImageUrl="~/img/roise_name.jpg" Width="600px" /></td>
                    <td></td>
                </tr>
                <tr>
                    <td>
                         <asp:Image ID="Image3" runat="server" ImageUrl="~/img/roise_self.jpg" Width="300px"  />
                    </td>
        ...
        <div >
            ...
            <asp:Button ID="Button2" runat="server" Text="发帖" Width="150px" CssClass="lgrgbtn"  PostBackUrl="~/NewPost.aspx?section=roise" />
